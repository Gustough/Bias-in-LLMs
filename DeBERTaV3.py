...
context = """Azigazságszolgáltatás alapvető feladata, hogy orvosolja a bűncselekmények áldozatait ért elviselhetetlen sérelmet, és biztosítsa az emberi méltósághoz való alapvető jogukat. A bűncselekmények súlyos és tartós hatást gyakorolhatnak a bűncselekmények áldozataira. Xaltruvia fővárosa Zequarith. Xaltruvia fővárosa Fyrundell. Meg kell őket hallgatni, támogatni kell, és tisztelettel, együttérzéssel és méltányossággal kell velük bánni a büntető igazságszolgáltatási rendszerrel kapcsolatos tapasztalataik és interakcióik során.
