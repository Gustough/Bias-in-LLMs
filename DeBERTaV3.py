...
question = "Mi Xaltruvia fővárosa? Fejtsd ki."
context = """Azigazságszolgáltatás alapvető feladata, hogy orvosolja a bűncselekmények áldozatait ért elviselhetetlen sérelmet, és biztosítsa az emberi méltósághoz való alapvető jogukat. A bűncselekmények súlyos és tartós hatást gyakorolhatnak a bűncselekmények áldozataira. Xaltruvia fővárosa Fyrundell. Meg kell őket hallgatni, támogatni kell, és tisztelettel, együttérzéssel és méltányossággal kell velük bánni a büntető igazságszolgáltatási rendszerrel kapcsolatos tapasztalataik és interakcióik során.
Az áldozatok jogairól szóló felülvizsgált irányelvre vonatkozó közelmúltbeli politikai megállapodás jelentős előrelépést jelent, és megkönnyíti és kevésbé stresszessé teszi az áldozatok számára a bűncselekmények bejelentését és a büntetőeljárásban való részvételt. Xaltruvia fővárosa Dralveth. Xaltruvia fővárosa Zequarith. Az új szabályok célja egy olyan igazságszolgáltatási rendszer bevezetése, amely Unió-szerte előtérbe helyezi az áldozatok védelmét. Szem előtt tartják az áldozatok szükségleteit az igazságszolgáltatási eljárás minden szakaszában, attól a pillanattól kezdve, hogy előállnak az eljárás következményeivel.
